...
namespace invoiceIntegration.helper
{
    public class IntegratedHelper
    {
            ...
            try
            {
                foreach (var invoice in invoices)
                {
                    ...
                    else
                    {
                        ...
                        newInvoice.DataFields.FieldByName("DIVISION").Value = divisionCode;
                        ...
                        if (invoice.type != (int)InvoiceType.BUYING_SERVICE && invoice.type != (int)InvoiceType.SELLING_SERVICE)
                        {
                            ...
                            if (dispatches_lines.AppendLine())
                            {
                                ...
                                dispatches_lines[0].FieldByName("DIVISION").Value = divisionCode;
                            ...
                            if (newInvoiceLines.AppendLine())
                            {
                                ...
                                else
                                {
                                    ...
                                    if (useProducerCode) // bazı distlerde ürün kodları producerCode a yazılı ,
                                    {
                                        ...
                                        {
                                            helper.LogFile("Üretici kod hatası", "", "", "", productCodeByProducer);
                                    ...
                                    else if (invoice.type == (int)InvoiceType.SELLING_SERVICE || invoice.type == (int)InvoiceType.BUYING_SERVICE)
                                    {
                                        newInvoiceLines[i].FieldByName("MASTER_CODE").Value =
                                            reader.getServiceCodeBySalesArtServiceCode(usePersonaProductCode + detail.code, invoice.type == 4 ? 1 : 2);
                                        newInvoiceLines[i].FieldByName("TYPE").Value = 4;
                                    }
                                    else
                                        newInvoiceLines[i].FieldByName("MASTER_CODE").Value = usePersonaProductCode + detail.code;
        ...
        public IntegratedWaybillStatus sendMultipleDespatch(List<LogoWaybill> despatches)
        {
            ...
            try
            {
                foreach (var despatch in despatches)
                {
                    ...
                    newDespatch.DataFields.FieldByName("DIVISION").Value = divisionCode;
                    ...
                    for (int i = 0; i < despatch.details.Count; i++)
                    {
                        if (newWaybillLines.AppendLine())
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    newWaybillLines[i].FieldByName("MASTER_CODE").Value = usePersonaProductCode + detail.code;
                                }
        ...
        public IntegratedOrderStatus sendMultipleOrder(List<Order> orders)
        {
            ...
            try
            {
                foreach (var order in orders)
                {
                    ...
                    newOrder.DataFields.FieldByName("DIVISION").Value = divisionCode;
                    ...
                    for (int i = 0; i < order.details.Count; i++)
                    {
                        if (newOrderLines.AppendLine())
                        {
                            ...
                            else
                            {
                                ...
                                newOrderLines[i].FieldByName("MASTER_CODE").Value = usePersonaProductCode + detail.productCode;
        ...
        //            #region gerekirse eklenir
        //            //if (!LogoObjectSettings.transferPaymentWithApproveDate)
        //            //{
        //            //    if (orderPayment.PaymentDate != null)
        //            //    {
        //            //        Tarih = DateTime.Parse(orderPayment.PaymentDate.ToString());
        //            //        string tarih1 = Tarih.ToString("dd" + LogoObjectSettings.DateDelimiter + "MM" + LogoObjectSettings.DateDelimiter + "yyyy");
        //            //        paymentData.DataFields.FieldByName("DATE").Value = tarih1;
        //            //        log.Debug("DATE : " + paymentData.DataFields.FieldByName("DATE").Value);
        //            //    }
        //            //}
        //            //else
        //            //{
        //            //    if (orderPayment.ApproveDate != null)
        //            //    {
        //            //        Tarih = DateTime.Parse(orderPayment.ApproveDate.ToString());
        //            //        string tarih1 = Tarih.ToString("dd" + LogoObjectSettings.DateDelimiter + "MM" + LogoObjectSettings.DateDelimiter + "yyyy");
        //            //        paymentData.DataFields.FieldByName("DATE").Value = tarih1;
        //            //        log.Debug("DATE : " + paymentData.DataFields.FieldByName("DATE").Value);
        //            //    }
        //            //    else if (orderPayment.PaymentDate != null)
        //            //    {
        //            //        Tarih = DateTime.Parse(orderPayment.PaymentDate.ToString());
        //            //        string tarih1 = Tarih.ToString("dd" + LogoObjectSettings.DateDelimiter + "MM" + LogoObjectSettings.DateDelimiter + "yyyy");
        //            //        paymentData.DataFields.FieldByName("DATE").Value = tarih1;
        ...
        //            //if (LogoObjectSettings.useDivision == true)
        //            //{
        //            //    paymentData.DataFields.FieldByName("DIVISION").Value = LogoObjectSettings.DivisionNo;
        //            //    if (LogoObjectSettings.setDepartmentsameDivision)
        //            //        paymentData.DataFields.FieldByName("DEPARTMENT").Value = LogoObjectSettings.DivisionNo;
        //            //    log.Debug("DIVISION : " + paymentData.DataFields.FieldByName("DIVISION").Value);
        //            //}
        //            //else if (orderPayment.Salesman.Firm.ExtCode != null)
        //            //{
        //            //    paymentData.DataFields.FieldByName("DIVISION").Value = orderPayment.Salesman.Firm.ExtCode;
        //            //    if (LogoObjectSettings.setDepartmentsameDivision)
        //            //        paymentData.DataFields.FieldByName("DEPARTMENT").Value = orderPayment.Salesman.Firm.ExtCode;
        //            //    log.Debug("DIVISION : " + paymentData.DataFields.FieldByName("DIVISION").Value);
        //            //}
        //            #endregion
